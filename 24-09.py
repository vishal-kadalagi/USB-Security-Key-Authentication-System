...
if check_removable_disk():
    usb_drive = 'F:'  # Replace 'E:' with the appropriate drive letter of your USB drive
...
# Create the full file path
    ...
    messagebox.showerror("ALERT", "Specified USB is not connected, the Software will not Run.")
